...
<template>
    ...
    <div class="flex flex-col w-full h-[100vh] justify-center items-center font-bold text-[3rem]">
    ...
    <div class="w-full flex flex-col items-center">
        <div class="flex flex-col xl:flex-row gap-[5rem] items-center mb-[25rem]">
            <div class="font-bold flex flex-col w-[30rem] ">
                <div class="text-[3rem] mb-[1rem]">Browse & <span class="text-red-500">Discover</span></div>
        ...
        <div class="flex flex-col-reverse xl:flex-row gap-[5rem] items-center mb-[25rem]">
            ...
            <div class="font-bold flex flex-col w-[30rem]">
                <div class="text-[3rem] mb-[1rem]"><span class="text-red-500">Wishlist</span></div>
                <div class="text-neutral-600 font-medium">
        ...
        <div class="flex flex-col xl:flex-row gap-[5rem] items-center mb-[20rem] xl:mb-[5rem]">
            <div class="font-bold flex flex-col w-[33rem]">
                <div class="text-[3rem] mb-[1rem]">Manage your <span class="text-red-500">collection</span></div>
                <div class="text-neutral-600 font-medium">
