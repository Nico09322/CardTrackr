    ...
    <div class="group bg-zinc-900 shadow-[0px_4px_13px_0px_rgba(0,_0,_0,_0.1)] p-[1rem] flex flex-col gap-[1rem] w-[10rem] md:w-[18rem] duration-200 items-center border-[0.15rem] rounded-lg border-zinc-800 hover:border-red-500 hover:z-20" @click="handleClick">
        ...
        <div class="flex justify-center">
            <div class=" flex justify-center items-center hover:cursor-pointer relative" @click="moreDetail">
                ...
                <div v-if="!error" class="overflow-hidden text-neutral-900 p-[1rem] flex flex-row justify-between absolute rounded-lg group-hover:bg-zinc-500/50  group-hover:opacity-100 w-full h-full opacity-0 duration-100">
