...
<template>
    <div v-if="isCollected == true" class="bg-zinc-900 shadow-[0px_4px_13px_0px_rgba(0,_0,_0,_0.1)] p-[1rem] rounded-lg flex flex-col gap-[1rem] w-[10rem] md:w-[18rem] duration-200 items-center border-[0.15rem] border-zinc-800 hover:border-red-500" @click="handleClick">
        ...
        <div class="flex justify-center">
            <div class="group flex justify-center items-center hover:cursor-pointer relative" @click="moreDetail">
                <img v-if="!error" @error="error = true" :src="img" class="rounded-lg group-hover: duration-100" alt="">
    ...
    <div v-if="isCollected != true" class="bg-zinc-900 shadow-[0px_4px_13px_0px_rgba(0,_0,_0,_0.1)] p-[1rem] rounded-lg flex flex-col gap-[1rem] w-[10rem] md:w-[18rem] duration-200 items-center border-[0.15rem] border-zinc-800 hover:border-red-500" @click="handleClick">
        ...
        <div class="flex justify-center">
            <div class="group flex justify-center items-center hover:cursor-pointer relative" @click="moreDetail">
                <img v-if="!error" @error="error = true" :src="props.image" class="grayscale opacity-50 rounded-lg group-hover: duration-100" alt="">
                <div v-if="!error" class="overflow-hidden text-neutral-900 p-[1rem] flex flex-row justify-between absolute rounded-lg group-hover:bg-neutral-500/50  group-hover:opacity-100 w-full h-full opacity-0 duration-100">
